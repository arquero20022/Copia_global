...
if [[ $action == "r" || $action == "R" ]]; then
    read -p "¿Está seguro que quiere reemplazar el contenido de la base de datos de DESARROLLO: ($db_dev) por el contenido de la base de datos de PRODUCCION: ($db_pro)? (s/n): " execute_script
